...
class Truck extends Vehicle {
    ...
    tow(vehicle) {
        // Check if the vehicle is a Truck or Car to access make and model
        ...
        // Check if the vehicle is a Truck or Car to access weight
        if (vehicle instanceof Truck || vehicle instanceof Car) {
            ...
            console.log('Vehicle weight is not available');
        }
    }
